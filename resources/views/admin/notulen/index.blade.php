                ...
                <table class="table table-bordered table-striped">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>{{ $c->tempat }}</td>
                            <td>
                                <a href="{{ route('view_notulen.admin', $c->id) }}" class="btn btn-warning btn-sm"><i class="fa-solid fa-eye" style="color: #ffffff;"></i></i>
                                </a>
                                <a href="{{ route('destroy_notulen.admin', $c->id) }}" class="btn btn-danger btn-sm"><i class="fa-solid fa-trash-can"></i>
                                </a>
                            </td>
                        </tr>
                        @endforeach
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <h1 class="modal-title fs-5" id="exampleModalLabel">Tambah Notulen</h1>
                <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
            </div>
            <div class="modal-body">
                <form action="{{ route('create_notulen.admin') }}" method="POST" enctype="multipart/form-data">
                    @csrf
                    <div class="mb-3">
